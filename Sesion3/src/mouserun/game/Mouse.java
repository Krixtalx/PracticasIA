 ...
 * Players implementing the Mouse must implement all abstract methods and place
 * the mouse in the mouserun.mouse package. MouseLoader will locate all mouse
...
public abstract class Mouse {
    ...
    // New: 01-21-2016
    /**
     * Get the current number of unique visited grids. It must be managed by the
     * user himself
     *
    ...
    // New: 01-21-2016
    /**
     * Increment the current number of unique visited grids. Use it fairly
     *
    ...
    // New: 01-21-2016
    /**
     * Get the current number of visited grids (steps). It must be managed by
     * the user himself
     *
    ...
    // New: 01-21-2016
    /**
     * Increment the steps (visited grids) given by the mouse. Do not call this
     * method, it is automatically managed by the application
     *
    ...
    /**
     * The move method is called every time a mouse reaches a new grid. This
     * method expects a decision to be made and returns the decision to be made
     * on how to move the Mouse next. Use the Mouse.UP, Mouse.DOWN, Mouse.LEFT,
     * Mouse.RIGHT, Mouse.BOMB as options for the decision. Players can do that
     * is need to implement an intelligent mouse.
     *
     * @param currentGrid The current grid the Mouse is at.
     * @param cheese The cheese to be seek.
     * @return The decision to move the mouse. Use Mouse.UP, Mouse.DOWN,
     * Mouse.LEFT, Mouse.RIGHT, Mouse.BOMB
     */
    public abstract int move(Grid currentGrid, Cheese cheese);

    /**
     * This method is called every time a mouse (including own implementation)
     * consumes a cheese and a new cheese is relocated. Usually utilized for
     * clean ups.
     */
    public abstract void newCheese();

    /**
     * This method is called every time the Mouse touches a bomb that is not
     * planted by it. Usually utilized for calibration.
     */
