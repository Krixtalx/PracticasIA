...
public class Conecta4 extends JFrame implements ActionListener {
	...
	private void run() {
		...
		if (iaplayer) {
//			Object[] modos = {"Fácil", "Normal", "Difícil", "Muerte y destrucción"};
//			String diffi = (String) JOptionPane.showInputDialog(this, "Seleccione dificultad:", "Dificultad", JOptionPane.PLAIN_MESSAGE, null, modos, "Normal");
//			int dificultad;
//			if (diffi.equals("Fácil")) {
//				dificultad = 5;
//			} else if (diffi.equals("Normal")) {
//				dificultad = 6;
//			} else if (diffi.equals("Difícil")){
//				dificultad = 7;
//			}else{
//				dificultad = 8;
//			}
